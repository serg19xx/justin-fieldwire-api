<?php
// Test Flight::start() in real index.php context
error_reporting(E_ALL);
ini_set('display_errors', 1);

echo "Testing Flight::start() in real index.php context...\n";
...
try {
    ...
    file_put_contents(__DIR__ . '/../logs/app.log', date('Y-m-d H:i:s') . ' - test-real-index-flight.php loaded' . PHP_EOL, FILE_APPEND);
    ...
    file_put_contents(__DIR__ . '/../logs/app.log', date('Y-m-d H:i:s') . ' - About to start FlightPHP' . PHP_EOL, FILE_APPEND);
    \Flight::start();
    ...
    echo "Stack trace:\n" . $e->getTraceAsString() . "\n";
    file_put_contents(__DIR__ . '/../logs/app.log', date('Y-m-d H:i:s') . ' - ERROR: ' . $e->getMessage() . PHP_EOL, FILE_APPEND);
}
?>
